...
public class MD5 implements Serializable
{
     ...
     *
     */
    private static final long serialVersionUID = -3423422958965658411L;
    ...
    public static void main(String args[]) {
        ...
        { //如果没有参数，执行标准的Test Suite
            /**System.out.println("MD5 Test suite:");
             ...
             System.out.println(m.getMD5ofStr("12345"));
             //System.out.println(m.getMD5ofStr(m.getMD5ofStr("12345")));
             System.out.println(m.getMD5ofStr("000000"));*/


            String mask = "!^&*(#@$%^)?$#@~";
            String newpass = "000000" + mask;
            newpass = newpass.substring(0, 16);
            MD5 md5 = new MD5();
            String md5str = md5.getMD5ofStr(newpass);
